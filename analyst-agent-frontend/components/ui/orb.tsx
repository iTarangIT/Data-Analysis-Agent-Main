...
/* ElevenLabs UI registry code, kept as shipped so it can be re-added over. Its three.js scene
   mutates textures and reads refs while building shader uniforms, which is how three is used
   but which the React Compiler's lint rules cannot follow. */
